...
function Hero() {
  ...
  return (
    <section className="w-full nav-height bg-black relative">
      <div className="h-5/6 w-full flex-center flex-col px-4 sm:px-6 lg:px-8">
        <p id="hero" className="hero-title opacity-0">
          iPhone 15 Pro
        </p>

        <div className="w-full max-w-2xl md:w-10/12 lg:max-w-4xl">
          <video
      ...
      <div
        id="cta"
        className="flex flex-col items-center opacity-0 translate-y-16 px-4 sm:px-6 lg:px-8 -mt-8"
      >
