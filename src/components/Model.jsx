...
const Model = () => {
  ...
  return (
    <section className="common-padding pb-10 md:pb-16">
      <div className="screen-max-width">

        {/* HEADING — moved DOWN */}
        <h1
          id="heading"
          className="section-heading mt-20 md:mt-28 lg:mt-32"
        >
          Take a closer look.
        </h1>
        ...
        <div className="flex flex-col items-center mt-2">
          ...
          <div className="mx-auto w-full mt-2">
            ...
            {/* Model title */}
            <p className="text-sm font-light text-center mb-4 transition-all duration-300">
              {model.title}
            </p>

            {/* Floating dock pulled closer */}
